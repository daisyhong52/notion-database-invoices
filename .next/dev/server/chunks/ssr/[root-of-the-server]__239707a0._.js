...
(()=>{
    const e = new Error("Cannot find module 'html2canvas-pro'");
...
async function generateInvoicePDF(records) {
    ...
    // Generate PDF for each invoice using existing DOM elements
    for(let index = 0; index < records.length; index++){
        ...
        console.log(`Generating PDF page ${index + 1} for ${record.company}...`);
        try {
            ...
            console.log(`✓ Page ${index + 1} added to PDF`);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__239707a0._.js.map