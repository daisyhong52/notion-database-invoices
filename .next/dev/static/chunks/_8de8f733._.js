...
function generateInvoiceHTML(record) {
    ...
    <div style="width: 794px; min-height: 1123px; padding: 60px; box-sizing: border-box; font-family: 'Malgun Gothic', 'Apple SD Gothic Neo', sans-serif; background: #fff; color: #000; page-break-after: always;">
      ...
      <div style="margin-bottom: 20px;">
        ...
        <div style="font-size: 14px; color: #666; margin-top: 4px;">${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$number$2d$to$2d$korean$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["numberToKorean"])(record.amount)}</div>
      </div>
...
//# sourceMappingURL=_8de8f733._.js.map